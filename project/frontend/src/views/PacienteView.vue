      ...
      <div class="flex justify-between items-center mb-6">
        <div>
          <h2 class="text-2xl font-bold text-primary flex items-center gap-2">
            <router-link to="/pacientes" class="text-gray-400 hover:text-primary transition-colors">
              <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
            </router-link>
            {{ $t('ficha_title') }}
          </h2>
        </div>
        <button @click="openDiagnosticoModal" class="btn btn-primary shadow-md hover:shadow-lg transition-all flex items-center gap-2">
            ...
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-200 flex flex-col sm:flex-row justify-between sm:items-center gap-2">
              ...
              <div class="text-sm text-gray-500 font-medium flex items-center gap-4">
                ...
                <div class="flex gap-2">
                  <button @click="editDiagnostico(diag)" class="text-blue-600 hover:text-blue-800" title="Editar">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                  </button>
                  <button v-if="isAdmin" @click="confirmDeleteModal(diag.id)" class="text-red-600 hover:text-red-800" title="Eliminar">
